(function() {
  var LogBuffer, bidirectionalHistory, child_process, commitSummaryRe, getHistory, getRefs, parseCommitSummary, parseRefs, path, util, waterfall, _;
  ...
  module.exports.bidirectionalHistory = bidirectionalHistory = function(root, outerCallback) {
    ...
    return getHistory(root, options, function(result, ok) {
      var commit, g, index, parent, parentIndex, sha, _base, _i, _j, _len, _len2, _ref, _ref2, _ref3;
      _ref = result.commits;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
          ...
          if (parentIndex) {
            g = (_base = result.commits[parentIndex.index]).children || (_base.children = []);
            g.push(commit.sha);
          }
        }
      }
      _ref3 = result.commitShaIndex;
      for (sha in _ref3) {
        index = _ref3[sha].index;
      ...
      return outerCallback(result, ok);
    });
  };
