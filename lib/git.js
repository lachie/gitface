(function() {
  var History, LogBuffer, bidirectionalHistory, child_process, commitSummaryRe, getHistory, getRefs, parseCommitSummary, parseRefs, path, rollupCommits, util, waterfall, writeTip, _;
  ...
  module.exports.bidirectionalHistory = bidirectionalHistory = function(root, outerCallback) {
    ...
    return getHistory(root, options, function(history, ok) {
      var c, commit, parent, parentSha, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
          ...
          if (parent = history.commitLookup[parentSha]) {
            c = parent.children || (parent.children = []);
            c.push(commit.sha);
          }
        }
      }
  ...
  rollupCommits = function(commit, history) {
    var parent, parentSha, _i, _len, _ref, _results;
    _ref = commit.parents;
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      parentSha = _ref[_i];
      _results.push((parent = history.commitLookup[parentSha]) ? commit.type === 'commit' && parent.type === 'commit' ? (commit.contains || (commit.contains = []), commit.contains.push(parent.sha), commit.containsRefs || (commit.containsRefs = [commit.refLabels]), commit.containsRefs.push(parent.refLabels), commit.parents = parent.parents, parent.squashed = true, rollupCommits(commit, history)) : void 0 : void 0);
    }
    return _results;
  };
  writeTip = function(tip, history, commit) {
    var parent, parentSha, _i, _len, _ref, _ref2, _results;
    if (commit != null) {
      (_ref = commit.tipSha) != null ? _ref : commit.tipSha = tip.sha;
    }
    _ref2 = commit.parents;
    _results = [];
    for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
      parentSha = _ref2[_i];
      _results.push((parent = history.commitLookup[parentSha]) ? writeTip(tip, history, parent) : void 0);
    }
    return _results;
  };
  module.exports.abbreviatedHistory = function(root, outerCallback) {
    ...
    return bidirectionalHistory(root, options, function(history, ok) {
      var commit, newCommits, seenCommits, tip, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3;
      seenCommits = {};
      _ref = history.commits;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        commit = _ref[_i];
