(function() {
  var LogBuffer, child_process, getHistory, getRefs, waterfall, _;
  child_process = require('child_process');
  LogBuffer = require('./log_buffer').LogBuffer;
  _ = require('underscore');
  waterfall = require('async').waterfall;
  module.exports.getHistory = getHistory = function(callback) {
  ...
  module.exports.getRefs = getRefs = function(callback) {
  ...
  module.exports.getHistoryWithRefs = function(outerCallback) {
    var options;
    ...
    return waterfall([
      function(callback) {
        return getRefs(function(data, err) {
        ...
        return getHistory(historyOptions, function(data, err) {
          return callback(null, data);
        });
      }, function(data, callback) {
  ...
  if (module.parent == null) {
    module.exports.getHistoryWithRefs({
      limit: 100
    }, function(data) {
